...
function del(){
	//判断有哪些checkbox框被选中了
	var idCheckboxs = document.getElementsByName("id");
	var url = "MemberAdminServlet?method=del";
	var checkedIds = [];
	for(var i=0; i<idCheckboxs.length; i++){
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="50" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">QQ</span></div></td>
        <td width="50" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">电话</span></div></td>
        <td width="70" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">地址</span></div></td>
        <td width="70" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">邮件</span></div></td>
        <td width="100" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">描述</span></div></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.nickname }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.qq }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.phone }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.address }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.email }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${a.description }</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="MemberAdminServlet?method=del&id=${a.id}" title="点击删除会员">删除</a>
        </div></td>
      </tr>
      </c:forEach>
      </c:if>
  ...
  <tr>
    <td height="30">
		<jsp:include page="/backend/common/pager.jsp">
			<jsp:param name="url" value="MemberAdminServlet"/>
		</jsp:include>
    </td>
  </tr>
</table>
