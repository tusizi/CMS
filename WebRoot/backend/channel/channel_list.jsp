  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="ChannelServlet?method=updateInput&id=${c.id}" title="点击查看和编辑频道">${c.name }</a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${c.description }</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="ChannelServlet?method=del&id=${c.id}" title="点击删除频道">删除</a> |
        <a href="ChannelServlet?method=updateInput&id=${c.id}" title="点击编辑频道">编辑</a>
        </div></td>
      </tr>
      </c:forEach>
      </c:if>
